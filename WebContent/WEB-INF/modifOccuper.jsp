								...
								<div class= "col-4">
									<div class="card" style="width: 18rem; margin-top: 150px">
										 <div class="card-header" style="text-align: center; background-color:green">
						    				<span style="color: white; font-size: 20px; font-weight: bold;">MODIFICATION OCCUPER</span>
						 				 </div>
									  <div class="card-body">
									
														<table style="text-align: center;" align="center">
															<tr>
																<td><input type="text" name="codeprof" value="${ occuper.codeprof }" disabled="disabled" class="form-control"></td>
															</tr>
															<tr>
																<td><input type="text" name="codesalle" value="${ occuper.codesalle }" disabled="disabled" class="form-control"></td>
															</tr>
															<tr>
																<td><input type="date" name="thedate" value="${ occuper.thedate }" placeholder="Date" required class="form-control"></td>
															</tr>
														</table><br>
														
															<div class="d-grid gap-2 col-10 mx-auto">
																<button type="submit" class="btn btn-outline-success" onclick="return confirm('Confirmez-vous la modification?')">Effectuer</button>		
															</div>
																<input type="hidden" value="modifier" name="action">
																<input type="hidden" value="${ occuper.codeprof }" name="codeprof">
																<input type="hidden" value="${ occuper.codesalle }" name="codesalle">
