    ...
    <div class="row">
        <div class="col min-vh-100 py-3">
            <!-- toggler -->
				...
				<div class="container">
					<form action="/GestionDeClasse/prof" method="post">
					  <div class="row">
					    <div class="col-1">
					    	<button type="button" class="btn btn-success"><a style="color: white" href = "/GestionDeClasse/newProf?action=new"><i class="bi-plus fs-5"></i></a></button>
					    </div>
					     <div class="col-4"></div>
					     <div class="col-2">
						       <select name="codeSearch" class="form-select">
										<option value ="" selected>Rechercher par...</option>
										<option value ="code">Code Prof</option>
					     ...
					     <div class="col-4">
					     	<div class="input-group">
							     	...
							     	<input type="text" name="nameSearch" placeholder="Entrer le nom ou le code prof" class="form-control" >
							     <div class="input-group-prepend">
							     	<button type="submit" class="btn btn-outline-dark"><i class="bi-search"></i></button>
						...
						<input type="hidden" value="rechercher" name="action">
							...
							<c:forEach items="${ Profs }" var="prf">	
								<tr>
									<td><c:out value="${ prf.codeprof }"/></td>
								    <td><c:out value="${ prf.nom }"/></td>
									<td><c:out value="${ prf.prenom }"/></td>
									<td><c:out value="${ prf.grade }"/></td>	
									<td>
					                    <button type="button" class="btn btn-success"><a style="color: white" href="/GestionDeClasse/prof?action=modifier&codeprof='<c:out value='${ prf.codeprof }' />'"><i class="bi-pencil-fill"></i></a></button>
					                    <button type="button" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer?')"><a style="color: white" href="/GestionDeClasse/prof?action=supprimer&codeprof=<c:out value='${prf.codeprof }' />"><i class="bi-trash"></i></a></button>
