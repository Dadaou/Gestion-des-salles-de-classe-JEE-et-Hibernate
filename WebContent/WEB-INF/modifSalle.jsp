						...
						<div class= "col-4">
							<div class="card" style="width: 18rem; margin-top: 150px">
								 <div class="card-header" style="text-align: center; background-color:green">
				    				<span style="color: white; font-size: 20px; font-weight: bold;">MODIFICATION SALLE</span>
				 				 </div>
							  <div class="card-body">
							
												<table style="text-align: center;" align="center">
													<tr>
														<td><input type="text" name="codesalle" placeholder="Code Salle" value="${ salle.codesalle }" disabled="disabled"></td>
													</tr>
													<tr>
														<td><input type="text" name="designation" placeholder="Designation" value="${ salle.designation }" required></td>
													</tr>
												</table><br>
												
													<div class="d-grid gap-2 col-10 mx-auto">
														<button type="submit" class="btn btn-outline-success" value="${ salle.codesalle }" name="codesalle" onclick="return confirm('Confirmez-vous la modification?')">Effectuer</button>
													</div>
